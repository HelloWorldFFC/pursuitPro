	...
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'px'}">
			...
			<view class="content-box" :class="{'center':mode === 2}" >
				...
				<input style="width: 160px;" :placeholder="placeholder" @input="inputChange" confirm-type="search" class="input" :class="{'center':!active && mode === 2}" :focus="isFocus" v-model="inputVal" @focus="focus" @blur="blur"/>
