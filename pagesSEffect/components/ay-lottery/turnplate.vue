	...
	<view>
		<view class="main">
			<view class="canvas-box">
				<view :animation="animationData" class="canvas-ct">
					...
					<view class="canvas-list">
						<view class="canvas-item" v-for="(iteml,index2) in awardsList" :key="index2">
							<view class="canvas-item-text" :style="[{transform:'rotate('+iteml.turn+')'}]">
								<text class="txt">{{iteml.award}}</text>
								<image class="canvas-item-text-img" src="https://cdn.pixabay.com/photo/2020/11/23/15/00/butterfly-5770034__340.jpg"></image>
							</view>
						</view>
					</view>
				</view>
